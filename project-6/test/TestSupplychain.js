...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function CreateDrug() that allows a manufacturer to create a drug", async() => {
        ...
        await supplyChain.harvestItem(upc, originManufacturerID, originManufacturerName, originManufacturerInformation, originManufacturerLatitude, originManufacturerLongitude, productNotes)
